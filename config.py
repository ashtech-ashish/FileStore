...
APP_ID = int(os.environ.get("APP_ID", "24348284")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "1282eb3350eaf441a244b9347b2bd18b") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002767069049")) #Your db channel Id
OWNER = os.environ.get("OWNER", "axsih") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "5457101197")) # Owner id
#--------------------------------------------
...
USER_REPLY_TEXT = "Hein ! Ye kya kar rhe ho!!"
#--------------------------------------------
